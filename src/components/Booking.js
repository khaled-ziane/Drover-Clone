      ...
      <div className="booking">
        ...
        <div className="flex-radio">
          <input
            ...
            onChange={props.sortHandler}
          />
          <label htmlFor="1-6">1 to 6 months</label>
          <br />
        </div>
        <div className="flex-radio">
          <input
            ...
            onChange={props.sortHandler}
          />
          <label htmlFor="7-12">7 to 12 months</label>
          <br />
        </div>
        <div className="flex-radio">
          <input
            ...
            id="13-18"
            name="duration"
            value="13 to 18 months"
            className="input-radio"
            onChange={props.sortHandler}
          />
          <label htmlFor="13-18">13 to 18 months</label>
          <br />
        </div>
        <div className="flex-radio">
          <input
